...
const patchBrowser = () => {
    ...
    // TODO(STENCIL-663): Remove code related to deprecated `safari10` field.
    {
        ...
        if (!index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-225fc508.js'); }).then(() => opts);
        }
    }
...
//# sourceMappingURL=my-stencil-project.cjs.js.map